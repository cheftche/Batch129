    ...
    public static void main(String[] args) {
        ...
        for (int w : arr){
            if (w<min){
                ...
                secMax = max; //max konteyner'ini degistirmek icin icindeki degeri alip secondmax'a koyariz
                max = w;

            }else if (w>secMax){
                secMax = w;
            }
            System.out.println("min:" + min + " max:" + max + " secMax:" + secMax); //min:-90 max:10001 secMax:8787
        }
