...
public class Q02_List_EkleCikar {
    ...
    public static void main(String[] args) {
        ...
        while (true){
            ...
            } else if (komut.equalsIgnoreCase("set")) { //set() method'u index'le calisir
                System.out.println("Güncellemek istediğiniz sayının indeksini giriniz");
               Integer guncellenecekSayi = input.nextInt(); //sayi olarak almak istedigimizde indexOf() methodu kullanilir, wrapper class'in icine koydugumuzdan Object oldu
