...
public class Arrays02 {
    ...
    public static void main(String[] args) {
        ...
        //ages.length methodu arrayin length'ini verir
        //length-1 son elemanin indexini verir

        //1.Yol: sort methodu java'yi yorar
       // Arrays.sort(ages); //sort() methodu array'deki elemanlari kucukten buyuge siralar  sort==>sirala demek
       ...
       // System.out.println(ages[0] + ages[ages.length-1]); //59
        ...
        System.out.println(minimum + maximum); //15 + 44 = 59
    }
}
