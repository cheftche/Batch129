...
public class Q03_DoWhile_TopunSicramasi {
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        do {
            sicramaSayisi++;
            toplamYol +=yukseklik; //asagi inene kadar olan yukseklik eklenir
            yukseklik = yukseklik*0.75; //3/4 u kadar yukari cikti
            toplamYol += yukseklik; //toplam yola onu da ekledik
