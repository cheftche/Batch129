...
public class Lists02 {
    ...
    Rastgele kullanici adi olusturan JAVA kodu yaziniz.
       ...
       5. Eger bu kullanici adi zaten varsa, sonuna rastgele sayi olusturup ekleyelim, ve gosterelim.
        ...
        String userName = input.nextLine().toUpperCase().trim(); //trim eger varsa bastaki ve sondaki spaceleri siler

        //1.Yol: Random tamsayi kullanmak icin
        //int random = (int)(Math.random()*100); // rastegele sayilar hep double geliyor, onu integer'a cevirmek icin "int" koyduk
