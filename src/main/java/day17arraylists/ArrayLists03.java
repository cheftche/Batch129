...
public class ArrayLists03 {
    ...
    public static void main(String[] args) {
        ...
        //remove() method'u index ile kullanilirsa; size(konteynera) sildigi elemani verir
        ...
        //remove() method'u index ile kullanilirsa; size o elemani silip silmedigini ifade eden true veya false verir
        ...
        System.out.println(p); //true (sildim dogru anlami verir)
