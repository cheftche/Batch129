...
public class Q02_If_Diskriminant {
    ...
    /*
        Katsayıları verilen ikinci dereceden 1 bilinmeyenli denklemin köklerini bulunuz.
        ax² + bx + c;
        Çözüm adımları
   ...
   */
    ...
    public static void main(String[] args) {
        ...
        if (delta>0){
            ...
            System.out.println("Denklemin 2 tane koku vardir: x1" + x1 + ", x2:" + x2);

        }else if (delta==0){
            double x = -b/(2*a);
            System.out.println("Denklemin 1 tane koku vardir: x=" +x);
