...
public class NestedIf04 {
    ...
    public static void main(String[] args) {
        ...
        /*
        Kullanicidan 0'dan kucuk 120'den buyuk deger giremeyecek sekilde datlari aldiktan sonra
        ...
        }else if (gender.equalsIgnoreCase("Kadin")){   //String'lerde == degil equals kullaniriz
